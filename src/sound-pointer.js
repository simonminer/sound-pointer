...
export class SoundPointer {
    ...
    getCurrentPan(horizontalPosition) {
        ...
        const pan = horizontalPosition / width * (this.maxRightPan - this.maxLeftPan) + this.maxLeftPan;
    ...
    getCurrentVolume(horizontalPosition) {
        const width = window.innerWidth;
        const volume = horizontalPosition / width * (this.maxVolume - this.minVolume) + this.minVolume;
    ...
    getCurrentFrequency(verticalPosition) {
        ...
        const frequency =
            ((height - verticalPosition) / height * (this.maxFrequency - this.minFrequency)) 
            + this.minFrequency;
